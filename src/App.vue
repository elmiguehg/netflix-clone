...
<template>
  <div class="fixed w-full h-screen bg-black">
    ...
    <div v-if="!showFullVideo" id="SideNav" class="flex z-40 items-center w-[100px] h-screen bg-black relative">
      <img class="absolute top-0 w-[30px] mt-10 ml-10" src="/images/netflix-logo.png" alt="">
      <div>
        <div class="py-1 mx-10 my-1">
          <Magnify fillColor="#FFFFFF" :size="30" class="cursor-pointer"/>
        </div>
        <div class="py-1 mx-10 my-6 border-b-4 border-b-red-500">
          <HomeOutline fillColor="#FFFFFF" :size="30" class="cursor-pointer"/>
        </div>
        <div class="py-1 mx-10 my-6">
